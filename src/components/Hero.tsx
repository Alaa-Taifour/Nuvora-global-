...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
      ...
      <div className="relative z-10 lg:col-span-7 flex flex-col justify-center px-8 lg:px-24 pt-32 pb-20 bg-navy-950">
        ...
        <motion.div
          ...
          className="max-w-3xl"
        >
          <div className="inline-flex items-center space-x-3 px-4 py-2 rounded-full glass border-white/10 mb-12">
            <div className="w-2 h-2 bg-cyan-accent rounded-full animate-ping" />
            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-400">Next-Gen AI Infrastructure</span>
          </div>
          
          <h1 className="text-7xl md:text-[140px] font-black tracking-tighter uppercase leading-[0.8] mb-12">
            AI That <br />
            <span className="text-gradient">Replaces</span> <br />
            <span className="text-white">Entire Teams</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-400 mb-16 font-medium leading-tight tracking-tight max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8">
            <Link to="/login" className="group relative bg-white text-black px-12 py-6 rounded-full text-xl font-black uppercase tracking-tighter flex items-center space-x-4 hover:bg-cyan-accent hover:text-white transition-all duration-700 apple-shadow overflow-hidden">
              ...
              <ArrowRight className="relative z-10 w-7 h-7 group-hover:translate-x-3 transition-transform" />
            </Link>
            <a href="#audit" className="px-12 py-6 rounded-full text-xl font-black uppercase tracking-tighter glass hover:bg-white/10 transition-all border border-white/10 apple-shadow">
              Get Free AI Audit
            </a>
          </div>

          <div className="mt-24 pt-12 border-t border-white/5 flex items-center space-x-12">
            <div className="flex -space-x-4">
              {[1, 2, 3, 4, 5].map(i => (
                <img key={i} src={`https://picsum.photos/seed/user${i}/100/100`} className="w-12 h-12 rounded-full border-4 border-navy-950 apple-shadow" referrerPolicy="no-referrer" />
              ))}
            </div>
            <div>
              <div className="text-lg font-black text-white">500+ Systems Deployed</div>
              <div className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Trusted by $100M+ Global Brands</div>
            </div>
          </div>
        </motion.div>
      </div>
